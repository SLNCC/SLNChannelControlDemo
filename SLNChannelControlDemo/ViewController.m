...
static CGFloat const fixCount = 0;
//菜单列数
...
- (void)viewDidLoad {
    ...
    _unUseTitles = [NSMutableArray arrayWithObjects:@"4",@"5",@"6", @"7",@"8",@"9",nil];
...
- (void)setUpcollectionViews{
    ...
    flowLayout.itemSize = CGSizeMake(cellWidth,50);
    ...
    _dragingItem = [[NTVChannelItem alloc] initWithFrame:CGRectMake(0, 0, cellWidth, 50)];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        NTVChannelItem *item = (NTVChannelItem*)[_collectionView cellForItemAtIndexPath:indexPath];
        item.icon = @"添加";
